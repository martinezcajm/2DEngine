...
cl /nologo /Zi /GR- /EHs /W4 /c /MD ..\src\sprite.cc   -I ..\deps  -I ..\deps\SFML\include
...
cl /nologo /Zi /GR- /EHs /W4 /c /MD ..\src\main_sfml.cc   -I ..\deps -I ..\deps\SFML\include -I ..\deps\imgui -I ..\deps\imgui-sfml
cl /nologo /Zi /GR- /EHs /W4 /MD /Fe:main_engine.exe main_sfml.obj entity.obj drawable_entity.obj rect.obj label.obj sprite.obj imgui.obj imgui_draw.obj imgui-SFML.obj ..\deps\SFML\lib\sfml-graphics.lib ..\deps\SFML\lib\sfml-window.lib ..\deps\SFML\lib\sfml-system.lib opengl32.lib shell32.lib user32.lib gdi32.lib
