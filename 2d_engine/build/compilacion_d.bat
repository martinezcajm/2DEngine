...
cl /nologo /Zi /GR- /EHs /W4 /c /MD ..\src\scene.cc -I ..\include -I ..\deps\SFML\include -I ..\deps\json-develop\src\ -I ..\deps\tinyfiledialogs
...
cl /nologo /Zi /GR- /EHs /W4 /MD /Fe:..\bin\main_engine.exe main_game.obj entity.obj drawable_entity.obj rect.obj label.obj window.obj game_manager.obj game.obj scene.obj sprite.obj background.obj pool.obj native_dialogs.obj tinyfiledialogs.obj imgui.obj imgui_demo.obj imgui_draw.obj imgui-SFML.obj ..\deps\SFML\lib\sfml-graphics.lib ..\deps\SFML\lib\sfml-window.lib ..\deps\SFML\lib\sfml-system.lib opengl32.lib shell32.lib user32.lib gdi32.lib Comdlg32.lib Ole32.lib
