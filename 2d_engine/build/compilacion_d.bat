...
cl /nologo /Zi /GR- /EHs /W4 /MD /Fe:main_engine.exe main_sfml.obj entity.obj drawable_entity.obj rect.obj label.obj sprite.obj ..\deps\SFML\lib\sfml-graphics.lib ..\deps\SFML\lib\sfml-window.lib ..\deps\SFML\lib\sfml-system.lib opengl32.lib shell32.lib user32.lib gdi32.lib
